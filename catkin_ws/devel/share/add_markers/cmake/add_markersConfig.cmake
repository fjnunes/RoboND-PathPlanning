...
if("TRUE" STREQUAL "TRUE")
  set(add_markers_SOURCE_PREFIX /home/workspace/RoboND-PathPlanning/catkin_ws/src/add_markers)
  set(add_markers_DEVEL_PREFIX /home/workspace/RoboND-PathPlanning/catkin_ws/devel)
  ...
  set(add_markers_INSTALL_PREFIX /home/workspace/RoboND-PathPlanning/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'add_markers' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'add_markers' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/workspace/RoboND-PathPlanning/catkin_ws/src/add_markers/${idir}'.  ${_report}")
    endif()
